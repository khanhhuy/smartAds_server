 ...
 * Generated for Laravel 5.0.33 on 2015-10-07.
 *
...
namespace {
    ...
    class Connector extends \App\Facades\Connector{
        ...
        public static function getSupermarketMSHost(){
            return \App\Services\ConnectorService::getSupermarketMSHost();
        }
         ...
         * @static 
         */
        public static function getItemIDsFromCategory($category){
            return \App\Services\ConnectorService::getItemIDsFromCategory($category);
        }
         ...
         * @static 
         */
        public static function getItemIDsFromCategoryID($categoryID){
            return \App\Services\ConnectorService::getItemIDsFromCategoryID($categoryID);
        }
         ...
         * @static 
         */
        public static function getTaxonomy($convertToArray = false){
            return \App\Services\ConnectorService::getTaxonomy($convertToArray);
        }
         ...
         * @static 
         */
        public static function getShoppingHistoryFromCustomer($customer, $fromDate = null, $toDate = null){
            return \App\Services\ConnectorService::getShoppingHistoryFromCustomer($customer, $fromDate, $toDate);
        }
         ...
         * @static 
         */
        public static function getStores($convertToArray = false){
            return \App\Services\ConnectorService::getStores($convertToArray);
        }
        ...
        public static function getCategoryFromItemID($itemID){
            return \App\Services\ConnectorService::getCategoryFromItemID($itemID);
        }
         ...
         * @static 
         */
        public static function validateAuthentication($email, $password){
            return \App\Services\ConnectorService::validateAuthentication($email, $password);
        }
         ...
         * @static 
         */
        public static function getCustomerFromEmail($email){
            return \App\Services\ConnectorService::getCustomerFromEmail($email);
        }
         ...
         * @static 
         */
        public static function registerCustomer($email, $password){
            return \App\Services\ConnectorService::registerCustomer($email, $password);
        }
        
    }


    class ContextAds extends \App\Facades\ContextAds{
         ...
         * @static 
         */
        public static function getContextAds($customer, $major, $minor){
            return \App\Services\ContextAdsService::getContextAds($customer, $major, $minor);
        }
        
    }


    class Mining extends \App\Facades\Mining{
         ...
         * @static 
         */
        public static function miningAllCustomer($fromDate = null, $toDate = null){
            return \App\Services\MiningSimpleService::miningAllCustomer($fromDate, $toDate);
        }
         ...
         * @static 
         */
        public static function miningCustomer($customer, $isContinue = false, $fromDate = null, $toDate = null){
            return \App\Services\MiningSimpleService::miningCustomer($customer, $isContinue, $fromDate, $toDate);
        }
    ...
    class Utils extends \App\Utils\Utils{
