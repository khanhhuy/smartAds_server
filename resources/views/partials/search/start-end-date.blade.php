<td>
    ...
    <input class="form-control table-search search_date second-row-in-cell" name="search_from_to" id="search_from_to"
...
<td>
    ...
    <input class="form-control form-control table-search search_date second-row-in-cell"
